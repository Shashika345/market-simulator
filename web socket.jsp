...
function showForm() {
    document.getElementById("addpalyer_name").style.display = '';
}

function hideForm() {
    document.getElementById("addplayer_name").style.display = "none";
}

function formSubmit() {
    var form = document.getElementById("addDeviceForm");
    var name = form.elements["palyer_name"].value;
    var type = form.elements["player_type"].value;
    var description = form.elements["player_description"].value;
    hideForm();
    document.getElementById("add_player").reset();
